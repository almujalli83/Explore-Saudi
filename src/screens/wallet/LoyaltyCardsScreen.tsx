...
const LOYALTY_CARDS = [
  { id: '1', name: 'Riyadh Season Pass', tier: 'Gold', points: 2450, icon: '🎭', colors: ['#D4A853', '#B8922E'] },
  { id: '2', name: 'Saudi Airlines Alfursan', tier: 'Silver', points: 15200, icon: '✈️', colors: ['#064D4D', '#0A6E6E'] },
  { id: '3', name: 'Jarir Bookstore Rewards', tier: 'Member', points: 890, icon: '📚', colors: ['#4A4A5A', '#1A1A2E'] },
  { id: '4', name: 'Starbucks Saudi', tier: 'Green', points: 340, icon: '☕', colors: ['#2ECC71', '#1A9E9E'] },
  { id: '5', name: 'Al Futtaim Rewards', tier: 'Member', points: 1200, icon: '🛍️', colors: ['#E74C3C', '#D4A853'] },
];
