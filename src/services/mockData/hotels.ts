export const hotels = [
  {
    id: 'h1', name: 'The Ritz-Carlton, Riyadh', nameAr: 'فندق الريتز كارلتون، الرياض', stars: 5, description: 'An opulent palace hotel set within 52 acres of landscaped gardens, featuring world-class dining, a luxury spa, and iconic Arabian architecture.', images: ['https://upload.wikimedia.org/wikipedia/commons/3/32/KAFD_January_2025.jpg', 'https://upload.wikimedia.org/wikipedia/en/thumb/b/b2/Kingdom_Centre_Riyadh_2024.jpeg/800px-Kingdom_Centre_Riyadh_2024.jpeg'], city: 'Riyadh', latitude: 24.6904, longitude: 46.6850, pricePerNight: 3500, amenities: ['Spa', 'Pool', 'Fine Dining', 'Gym', 'Business Center', 'Concierge', 'Valet', 'WiFi'], rating: 4.8, reviewCount: 1850,
    roomTypes: [
  ...
  {
    id: 'h3', name: 'Banyan Tree AlUla', nameAr: 'بانيان تري العلا', stars: 5, description: 'An extraordinary desert resort with private villas nestled among the ancient sandstone formations of AlUla, offering unparalleled stargazing and heritage experiences.', images: ['https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Masmak_Fort_%2812753717253%29.jpg/800px-Masmak_Fort_%2812753717253%29.jpg', 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Masmak_Castle_from_Thumairi.jpg/800px-Masmak_Castle_from_Thumairi.jpg'], city: 'AlUla', latitude: 26.6100, longitude: 37.9200, pricePerNight: 4200, amenities: ['Private Pool', 'Desert Tours', 'Spa', 'Stargazing', 'Heritage Excursions', 'Fine Dining'], rating: 4.9, reviewCount: 680,
    roomTypes: [
  ...
  {
    id: 'h5', name: 'St. Regis Red Sea', nameAr: 'سانت ريجس البحر الأحمر', stars: 5, description: 'An exclusive island resort in the Red Sea project offering pristine beaches, coral reef diving, and butler-serviced overwater and beachfront villas.', images: ['https://upload.wikimedia.org/wikipedia/commons/7/7e/The_king_Abdullah_Financial_District..JPG', 'https://upload.wikimedia.org/wikipedia/commons/8/8a/Aramco_Tower.jpg'], city: 'Red Sea', latitude: 25.8000, longitude: 36.5000, pricePerNight: 5000, amenities: ['Private Beach', 'Diving', 'Spa', 'Water Sports', 'Butler Service', 'Marina', 'Restaurants'], rating: 4.9, reviewCount: 340,
    roomTypes: [
  ...
  {
    id: 'h6', name: 'Park Hyatt Jeddah', nameAr: 'بارك حياة جدة', stars: 5, description: 'A beachfront luxury hotel on the Jeddah Corniche with stunning Red Sea views, private beach, and world-class Mediterranean dining.', images: ['https://upload.wikimedia.org/wikipedia/commons/3/32/KAFD_January_2025.jpg', 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/King_Fahd%E2%80%99s_Fountain.jpg/800px-King_Fahd%E2%80%99s_Fountain.jpg'], city: 'Jeddah', latitude: 21.5600, longitude: 39.1050, pricePerNight: 2200, amenities: ['Private Beach', 'Pool', 'Spa', 'Gym', 'Restaurants', 'Marina', 'WiFi'], rating: 4.6, reviewCount: 1600,
    roomTypes: [
  ...
  {
    id: 'h7', name: 'Hilton Riyadh Hotel & Residences', nameAr: 'هيلتون الرياض', stars: 4, description: 'A modern business and leisure hotel in central Riyadh with excellent facilities, multiple restaurants, and easy access to major attractions.', images: ['https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/Old_Jeddah_%28Al_Balad%29_architecture_3_Feb_2022.jpg/800px-Old_Jeddah_%28Al_Balad%29_architecture_3_Feb_2022.jpg', 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Bayt_Nasif%2C_1872%2C_old_Jeddah%2C_Saudi_Arabia_%285%29_%2850703484406%29.jpg/800px-Bayt_Nasif%2C_1872%2C_old_Jeddah%2C_Saudi_Arabia_%285%29_%2850703484406%29.jpg'], city: 'Riyadh', latitude: 24.6900, longitude: 46.6900, pricePerNight: 850, amenities: ['Pool', 'Gym', 'Restaurant', 'Business Center', 'Parking', 'WiFi'], rating: 4.3, reviewCount: 3200,
    roomTypes: [
  ...
  {
    id: 'h10', name: 'Shaden Resort, AlUla', nameAr: 'منتجع شادن العلا', stars: 4, description: 'A unique desert resort offering eco-friendly mirrored lodges that blend into the AlUla landscape, providing an intimate connection with the ancient desert.', images: ['https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/Old_Jeddah_%28Al_Balad%29_architecture_3_Feb_2022.jpg/800px-Old_Jeddah_%28Al_Balad%29_architecture_3_Feb_2022.jpg', 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Bayt_Nasif%2C_1872%2C_old_Jeddah%2C_Saudi_Arabia_%285%29_%2850703484406%29.jpg/800px-Bayt_Nasif%2C_1872%2C_old_Jeddah%2C_Saudi_Arabia_%285%29_%2850703484406%29.jpg'], city: 'AlUla', latitude: 26.6150, longitude: 37.9150, pricePerNight: 1800, amenities: ['Desert View', 'Restaurant', 'Tours', 'Stargazing', 'WiFi'], rating: 4.5, reviewCount: 420,
    roomTypes: [
  ...
  {
    id: 'h11', name: 'Crowne Plaza Riyadh', nameAr: 'كراون بلازا الرياض', stars: 4, description: 'A reliable business hotel on King Fahd Road with modern facilities, a full-service spa, and multiple dining venues serving international cuisine.', images: ['https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Jokhdar_House_2024.jpg/800px-Jokhdar_House_2024.jpg', 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Jeddah_Tower_in_its_88th_floor_%28cropped%29.jpg/800px-Jeddah_Tower_in_its_88th_floor_%28cropped%29.jpg'], city: 'Riyadh', latitude: 24.7000, longitude: 46.6800, pricePerNight: 650, amenities: ['Spa', 'Pool', 'Gym', 'Restaurant', 'Business Center', 'WiFi'], rating: 4.2, reviewCount: 1900,
    roomTypes: [
