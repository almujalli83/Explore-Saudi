export const hotels = [
  {
    id: 'h1', name: 'The Ritz-Carlton, Riyadh', nameAr: 'فندق الريتز كارلتون، الرياض', stars: 5, description: 'An opulent palace hotel set within 52 acres of landscaped gardens, featuring world-class dining, a luxury spa, and iconic Arabian architecture.', images: ['https://images.pexels.com/photos/695193/pexels-photo-695193.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/34672504/pexels-photo-34672504.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'Riyadh', latitude: 24.6904, longitude: 46.6850, pricePerNight: 3500, amenities: ['Spa', 'Pool', 'Fine Dining', 'Gym', 'Business Center', 'Concierge', 'Valet', 'WiFi'], rating: 4.8, reviewCount: 1850,
    roomTypes: [
  ...
  {
    id: 'h3', name: 'Banyan Tree AlUla', nameAr: 'بانيان تري العلا', stars: 5, description: 'An extraordinary desert resort with private villas nestled among the ancient sandstone formations of AlUla, offering unparalleled stargazing and heritage experiences.', images: ['https://images.pexels.com/photos/18611226/pexels-photo-18611226.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/50628/pexels-photo-50628.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'AlUla', latitude: 26.6100, longitude: 37.9200, pricePerNight: 4200, amenities: ['Private Pool', 'Desert Tours', 'Spa', 'Stargazing', 'Heritage Excursions', 'Fine Dining'], rating: 4.9, reviewCount: 680,
    roomTypes: [
  ...
  {
    id: 'h4', name: 'Habitas AlUla', nameAr: 'هابيتاس العلا', stars: 5, description: 'A boutique eco-luxury resort built into the AlUla canyon, combining sustainable design with immersive wellness experiences and Nabataean heritage.', images: ['https://images.pexels.com/photos/8333637/pexels-photo-8333637.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/5863922/pexels-photo-5863922.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'AlUla', latitude: 26.6200, longitude: 37.9100, pricePerNight: 3800, amenities: ['Wellness Center', 'Canyon Pool', 'Yoga', 'Desert Safari', 'Organic Dining', 'Stargazing'], rating: 4.8, reviewCount: 520,
    roomTypes: [
  ...
  {
    id: 'h5', name: 'St. Regis Red Sea', nameAr: 'سانت ريجس البحر الأحمر', stars: 5, description: 'An exclusive island resort in the Red Sea project offering pristine beaches, coral reef diving, and butler-serviced overwater and beachfront villas.', images: ['https://images.pexels.com/photos/5967950/pexels-photo-5967950.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/3760999/pexels-photo-3760999.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'Red Sea', latitude: 25.8000, longitude: 36.5000, pricePerNight: 5000, amenities: ['Private Beach', 'Diving', 'Spa', 'Water Sports', 'Butler Service', 'Marina', 'Restaurants'], rating: 4.9, reviewCount: 340,
    roomTypes: [
  ...
  {
    id: 'h6', name: 'Park Hyatt Jeddah', nameAr: 'بارك حياة جدة', stars: 5, description: 'A beachfront luxury hotel on the Jeddah Corniche with stunning Red Sea views, private beach, and world-class Mediterranean dining.', images: ['https://images.pexels.com/photos/17455023/pexels-photo-17455023.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/3760999/pexels-photo-3760999.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'Jeddah', latitude: 21.5600, longitude: 39.1050, pricePerNight: 2200, amenities: ['Private Beach', 'Pool', 'Spa', 'Gym', 'Restaurants', 'Marina', 'WiFi'], rating: 4.6, reviewCount: 1600,
    roomTypes: [
  ...
  {
    id: 'h7', name: 'Hilton Riyadh Hotel & Residences', nameAr: 'هيلتون الرياض', stars: 4, description: 'A modern business and leisure hotel in central Riyadh with excellent facilities, multiple restaurants, and easy access to major attractions.', images: ['https://images.pexels.com/photos/15839821/pexels-photo-15839821.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/35761/pexels-photo-35761.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'Riyadh', latitude: 24.6900, longitude: 46.6900, pricePerNight: 850, amenities: ['Pool', 'Gym', 'Restaurant', 'Business Center', 'Parking', 'WiFi'], rating: 4.3, reviewCount: 3200,
    roomTypes: [
  ...
  {
    id: 'h10', name: 'Shaden Resort, AlUla', nameAr: 'منتجع شادن العلا', stars: 4, description: 'A unique desert resort offering eco-friendly mirrored lodges that blend into the AlUla landscape, providing an intimate connection with the ancient desert.', images: ['https://images.pexels.com/photos/50628/pexels-photo-50628.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/8333637/pexels-photo-8333637.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'AlUla', latitude: 26.6150, longitude: 37.9150, pricePerNight: 1800, amenities: ['Desert View', 'Restaurant', 'Tours', 'Stargazing', 'WiFi'], rating: 4.5, reviewCount: 420,
    roomTypes: [
  ...
  {
    id: 'h11', name: 'Crowne Plaza Riyadh', nameAr: 'كراون بلازا الرياض', stars: 4, description: 'A reliable business hotel on King Fahd Road with modern facilities, a full-service spa, and multiple dining venues serving international cuisine.', images: ['https://images.pexels.com/photos/15839821/pexels-photo-15839821.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/695193/pexels-photo-695193.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'Riyadh', latitude: 24.7000, longitude: 46.6800, pricePerNight: 650, amenities: ['Spa', 'Pool', 'Gym', 'Restaurant', 'Business Center', 'WiFi'], rating: 4.2, reviewCount: 1900,
    roomTypes: [
