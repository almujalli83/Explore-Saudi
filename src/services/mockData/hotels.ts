export const hotels = [
  ...
  {
    id: 'h3', name: 'Banyan Tree AlUla', nameAr: 'بانيان تري العلا', stars: 5, description: 'An extraordinary desert resort with private villas nestled among the ancient sandstone formations of AlUla, offering unparalleled stargazing and heritage experiences.', images: ['https://images.pexels.com/photos/9822971/pexels-photo-9822971.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/68358/pexels-photo-68358.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'AlUla', latitude: 26.6100, longitude: 37.9200, pricePerNight: 4200, amenities: ['Private Pool', 'Desert Tours', 'Spa', 'Stargazing', 'Heritage Excursions', 'Fine Dining'], rating: 4.9, reviewCount: 680,
    roomTypes: [
  ...
  {
    id: 'h4', name: 'Habitas AlUla', nameAr: 'هابيتاس العلا', stars: 5, description: 'A boutique eco-luxury resort built into the AlUla canyon, combining sustainable design with immersive wellness experiences and Nabataean heritage.', images: ['https://images.pexels.com/photos/68358/pexels-photo-68358.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/9822971/pexels-photo-9822971.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'AlUla', latitude: 26.6200, longitude: 37.9100, pricePerNight: 3800, amenities: ['Wellness Center', 'Canyon Pool', 'Yoga', 'Desert Safari', 'Organic Dining', 'Stargazing'], rating: 4.8, reviewCount: 520,
    roomTypes: [
  ...
  {
    id: 'h5', name: 'St. Regis Red Sea', nameAr: 'سانت ريجس البحر الأحمر', stars: 5, description: 'An exclusive island resort in the Red Sea project offering pristine beaches, coral reef diving, and butler-serviced overwater and beachfront villas.', images: ['https://images.pexels.com/photos/3100361/pexels-photo-3100361.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/5967950/pexels-photo-5967950.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'Red Sea', latitude: 25.8000, longitude: 36.5000, pricePerNight: 5000, amenities: ['Private Beach', 'Diving', 'Spa', 'Water Sports', 'Butler Service', 'Marina', 'Restaurants'], rating: 4.9, reviewCount: 340,
    roomTypes: [
  ...
  {
    id: 'h6', name: 'Park Hyatt Jeddah', nameAr: 'بارك حياة جدة', stars: 5, description: 'A beachfront luxury hotel on the Jeddah Corniche with stunning Red Sea views, private beach, and world-class Mediterranean dining.', images: ['https://images.pexels.com/photos/5625713/pexels-photo-5625713.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/20755938/pexels-photo-20755938.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'Jeddah', latitude: 21.5600, longitude: 39.1050, pricePerNight: 2200, amenities: ['Private Beach', 'Pool', 'Spa', 'Gym', 'Restaurants', 'Marina', 'WiFi'], rating: 4.6, reviewCount: 1600,
    roomTypes: [
  ...
  {
    id: 'h10', name: 'Shaden Resort, AlUla', nameAr: 'منتجع شادن العلا', stars: 4, description: 'A unique desert resort offering eco-friendly mirrored lodges that blend into the AlUla landscape, providing an intimate connection with the ancient desert.', images: ['https://images.pexels.com/photos/9822971/pexels-photo-9822971.jpeg?auto=compress&cs=tinysrgb&w=800', 'https://images.pexels.com/photos/17923076/pexels-photo-17923076.jpeg?auto=compress&cs=tinysrgb&w=800'], city: 'AlUla', latitude: 26.6150, longitude: 37.9150, pricePerNight: 1800, amenities: ['Desert View', 'Restaurant', 'Tours', 'Stargazing', 'WiFi'], rating: 4.5, reviewCount: 420,
    roomTypes: [
